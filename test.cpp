...
int main(int argc, const char* argv[])
{
    ...
    std::vector<Edge> edge_list = {Edge(1, 2), Edge(0, 4), Edge(1, 5), Edge(2, 6), Edge(3, 7), Edge(4, 5), Edge(6, 7), Edge(4, 8), 
        Edge(5, 9), Edge(6, 10), Edge(7, 11), Edge(10, 11), Edge(8, 13), Edge(9, 14), Edge(10, 15), Edge(11, 16), Edge(14, 15), Edge(12, 13), Edge(16, 17)
    };
    std::vector<EdgeProperty> edge_property_list = {EdgeProperty(5), EdgeProperty(1), EdgeProperty(4), EdgeProperty(1), EdgeProperty(4), 
        EdgeProperty(7), EdgeProperty(5), EdgeProperty(2), EdgeProperty(5), EdgeProperty(6), 
        EdgeProperty(5), EdgeProperty(4), EdgeProperty(4), EdgeProperty(4), EdgeProperty(7), 
        EdgeProperty(6), EdgeProperty(6), EdgeProperty(2), EdgeProperty(5)
    };
    assert(edge_list.size() == edge_property_list.size());
    my_graph g(edge_list.begin(), edge_list.end(), edge_property_list.begin(), n_vertices);
